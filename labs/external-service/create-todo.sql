...
CREATE USER 'todoapp'@'localhost' IDENTIFIED BY 'redhat123';
CREATE USER 'todoapp'@'%' IDENTIFIED BY 'redhat123';
GRANT SELECT ON todo.* to 'todoapp'@'localhost';
GRANT SELECT ON todo.* to 'todoapp'@'%';
